...
<footer class="footer">
  <div class="d-sm-flex justify-content-center justify-content-sm-between">
    <span class="float-none float-sm-end d-block mt-1 mt-sm-0 text-center">Copyright © NandaKur2024.</span>
  </div>
</footer>
        <!-- partial -->
      </div>
  ...
  <script src="<?=base_url('assets/src/')?>assets/vendors/bootstrap-datepicker/bootstrap-datepicker.min.js"></script>
  <!-- endinject -->
  ...
  <script src="<?=base_url('assets/src/')?>assets/js/dashboard.js"></script>
  <script src="<?=base_url('assets/src/')?>assets/js/proBanner.js"></script>
